...
fn test_rori() {
    ...
    trace_fmt!(" rori ");
    trace_fmt!(" 0x{:x}", rori(u32:0b00100000000000000000000000000000, u32:1));
}
...
fn test_andn() {
    ...
    trace_fmt!(" andn ");
    trace_fmt!(" 0x{:x}", andn(u32:0b00000000000000000000000010101101, u32:0b00000000000000000000000011001100));
}
...
fn test_orn() {
    ...
    trace_fmt!(" orn ");
    trace_fmt!(" 0x{:x}", orn(u32:0b00000000000000000000000010101100, u32:0b00000000000000000000000011000101));
}
...
fn test_xnor() {
    ...
    trace_fmt!(" xnor ");
    trace_fmt!(" 0x{:x}", xnor(u32:0b00000000000000000000000010101100, u32:0b00000000000000000000000011000101));
}
...
fn test_pack() {
    ...
    trace_fmt!(" pack ");
    trace_fmt!(" 0x{:x}", pack(u32:0b00000000000011110000000000001111, u32:0b11111111000000000000000011111111));
}
...
fn test_packh() {
    ...
    trace_fmt!(" packh ");
    trace_fmt!(" 0x{:x}", packh(u32:0b00000000000000000000000011110000, u32:0b11110000000000000000000000000000));
}
...
fn test_brev8() {
    ...
    trace_fmt!(" brev8 ");
    trace_fmt!(" 0x{:x}", brev8(u32:0b00000001000000100000001100000100));
}
...
fn test_rev8() {
    ...
    trace_fmt!(" rev8 ");
    trace_fmt!(" 0x{:x}", rev8(u32:0b00000001000000100000001100000100));
}
...
fn full_test_zip() {
    ...
    trace_fmt!(" zip ");
    trace_fmt!(" 0x{:x}", zip(u32:0b01010101010101011111111111111111));
}
...
fn test_unzip() {
    ...
    trace_fmt!(" unzip ");
    trace_fmt!(" 0x{:x}", unzip(u32:0b01110111011101110111011101110111));
    trace_fmt!(" unzip ");
    trace_fmt!(" 0x{:x}", unzip(u32:0b11001100110011001100110011001100));
}
